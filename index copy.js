...
const { fetchEcoindexData, initializeEcoindexData } = require('./app/middlewares/fetchEcoindexData');
const router = require('./routes/router');
const path = require('path');
const cron = require('node-cron');
const { mergeData, initializeGlobalData } = require('./app/middlewares/mergeData');


/*
// Start all cron jobs
require('./app/controllers/crons-controller');
*/
